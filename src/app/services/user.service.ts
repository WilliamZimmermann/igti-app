...
export class UserService{
    ...
    public addUser(user: User): Observable<User> {
        let url: string = this.BASE_URL+ '/api/createuser';
        return this.http.post<User>(url, user, httpOptions)
        .pipe(
            tap((retorno: User) => this.log("User Add")),
            catchError(this.handleError<User>('add'))
        );
    }

    public editUser(user: User): Observable<User> {
        let url: string = this.BASE_URL+'/api/edituser';
    ...
    public getUsers(): Observable<User[]> {
        ...
        let url: string = this.BASE_URL+'/api/getAllUsers';
    ...
    public deleteUser(user: User | number): Observable<User> {
        ...
        // monta a url
        let url: string = this.BASE_URL + '/api/deleteuser/' + id;
        console.log(url);
